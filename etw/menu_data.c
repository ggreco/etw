...
#else
    {27,56,150,81,4,7,9,msg_85}, // Main menu
    {27,111,150,136,MENU_PREFS,3,0,msg_86},
    {1,1,1,1,3,6,8,NULL}, // hidden on iOS
    {172,56,295,81,2,11,12,msg_88},
    {172,111,295,136,10,8,15,msg_89},
    {27 + 67,168,150 + 67,193,-1,9,11,msg_90}, // +67 to put it in the middle
#endif
};
...
struct Button vprefs_bottoni[]=
{
    ...
    {10,130,100,137,-1,0,3,msg_230 },{101,130,184,137,-1,3,0,NULL },
    {72,220,246,232,MENU_PREFS,14,13,msg_108},
};
