...
struct Button score_bottoni[]=
{
    ...
    {20,83,150,106,-1,8,15,"WORLD"},
    {20,119,150,142,-1,8,15,"ACHIEVEMENTS"},
...
struct Button gprefs_bottoni[]=
{
    ...
    {10,148,100,158,-1,0,3,"CHANGE ACTIVE"},{101,148,184,158,-1,3,0,NULL},
    ...
    {10,190,100,206,-1,0,3,"CHANGE ACTIVE"},{101,190,184,206,-1,3,0,NULL},
...
struct Button button_substitutions[]=
{
    ...
    {20,239,140,251,-1,14,13, msg_0}, {180,239,300,251,-1,14,13,"CANCEL"},
#else
    ...
    {10,230,145,252,-1,14,13, msg_0}, {175,230,310,252,-1,14,13,"CANCEL"},
#endif
};
...
struct GfxMenu menu[]=
{
    ...
    {"SUBSTITUTIONS",button_substitutions,panel_substitutions,SZ(button_substitutions),SZ(panel_substitutions),-1,0,0,-1,6,8,(void *)TeamSubstitutions},
};
